package br.com.noteschool.springutilcore.util.hibernate;
...
public class AliasToBeanNestedResultTransformer extends AliasedTupleSubsetResultTransformer {
	...
	public Object transformTuple(Object[] tuple, String[] aliases) {
		...
		for (Class<?> subclass : subclassToAlias.keySet()) {
			...
			propertyAccessStrategy.buildPropertyAccess(resultClass, (String)subclassToAlias.get(subclass).get(2)).getSetter().set(root, subObject, null);
		}
